...
int ask_for_param(std::string message, int min, int max, int default) {

	std::cout << message << "(default: " << default << "): ";
	std::string s;
...
float ask_for_paramf(std::string message, float min, float max, float default) {
