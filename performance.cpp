...
void Performance::compute_error(const std::string &filename, int fr, std::vector<float> &points, std::vector<float> &reflect, std::vector<int> &in_points_per_pix, std::vector<float> &background, float time, float distance, float hyperparam)
{
...
void Performance::save_timing(const std::string &filename, float time)
{
